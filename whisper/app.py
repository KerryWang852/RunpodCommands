...
MODEL_NAME = "openai/whisper-medium-v3"
BATCH_SIZE = 8
FILE_LIMIT_MB = 1000
...
mf_transcribe = gr.Interface(
    ...
    # outputs="text",
    outputs=gr.outputs.JSON(), # 使用JSON输出来显示带时间戳的结果
    layout="horizontal",
    theme="huggingface",
...
demo.launch(enable_queue=True, server_port=8000, server_name="0.0.0.0")
